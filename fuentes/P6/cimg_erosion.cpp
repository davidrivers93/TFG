...
void ayuda()
{
	...
	fprintf(stderr,"Uso: cimg_erosion  [opciones] imagen_in [imagen_out] \n");
	...
	fprintf(stderr,"Funcion: Realiza un erosion  con cuadrados o segmentos horizontales o verticales \n");
}
int main(int argc, char **argv)
{
	...
	CImg<unsigned char> erosionada = entradaf.get_erode(tamx,tamy);

	if (residue )
		erosionada = entradaf - erosionada;
	...
	{
		erosionada.save(argv[optind+1]);
		strcpy(titulo,argv[optind+1]);
	}

	if(pintarventana)
		erosionada.display(titulo,0);
